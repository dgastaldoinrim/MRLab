...
##Test scripts (only to be run when the class is running as a standalone)
#import Manager
...
#    electrometer = Keithley6517A(rm, 'GPIB0::27::INSTR')
...
#    print(electrometer.identity)
    #electrometer.system_configuration()
    #electrometer.display_configuration()
    #electrometer.format_configuration(data_elements = 'READ')
    #electrometer.resistance_sense_configuration()
    #electrometer.voltage_source_configuration(voltage = 10, meter_connect = True)
    #electrometer.arm_configuration()
    #electrometer.trigger_configuration()
## Test mode # 1 = single resistance measurement for 3 temperatures and 3 fields.
#    for temperature in temperatures:
#        for field in fields:
#            electrometer.acquire_measurements('C:/Users/Daniele Gastaldo/Google Drive/Dati PhD Daniele/Prove MRLab/Dati esame/6517A/', 'Banco resistenze mode 1', 'MR', T = temperature, H = field)
#            electrometer.trigger_configuration(count = 20)
## Test mode # 2 = multiple resistance measurement for 3 temperatures and 3 fields.
#    for temperature in temperatures:
#        for field in fields:
#    electrometer.acquire_measurements('C:/Users/Daniele Gastaldo/Google Drive/Dati PhD Daniele/Prove MRLab/Dati esame/6517A/', 'Banco resistenze mode 2', 'MR', T = 10, H = 0)
#    electrometer.format_configuration(data_elements = 'VSO,READ')
## Test mode # 3 = single linear sweep measurement for 3 temperatures and 3 fields.
#    for temperature in temperatures:
#        for field in fields:
#            electrometer.acquire_linear_sweeps(1, -10, +10, 20, 'C:/Users/Daniele Gastaldo/Google Drive/Dati PhD Daniele/Prove MRLab/Dati esame/6517A/', 'Banco resistenze mode 3', 'MR', T = temperature, H = field, auto_range = 'Off', manual_range = 1e-7)
## Test mode # 4 = multiple linear sweep measurement for 3 temperatures and 3 fields.
#    for temperature in temperatures:
#        for field in fields:
#            electrometer.acquire_linear_sweeps(2, -10, +10, 20, 'C:/Users/Daniele Gastaldo/Google Drive/Dati PhD Daniele/Prove MRLab/Dati esame/6517A/', 'Banco resistenze mode 4', 'MR', T = temperature, H = field, auto_range = 'Off', manual_range = 1e-7)
## Test mode # 5 = single logarithmic sweep measurement for 3 temperatures and 3 fields.
#    for temperature in temperatures:
#        for field in fields:
#            electrometer.acquire_logarithmic_sweeps(1, 1, 10, 20, 'C:/Users/Daniele Gastaldo/Google Drive/Dati PhD Daniele/Prove MRLab/Dati esame/6517A/', 'Banco resistenze mode 5', 'MR', T = temperature, H = field, auto_range = 'Off', manual_range = 1e-7)
## Test mode # 6 = multiple logarithmic sweep measurement for 3 temperatures and 3 fields.
#    for temperature in temperatures:
#        for field in fields:
#            electrometer.acquire_logarithmic_sweeps(2, 1, 10, 20, 'C:/Users/Daniele Gastaldo/Google Drive/Dati PhD Daniele/Prove MRLab/Dati esame/6517A/', 'Banco resistenze mode 6', 'MR', T = temperature, H = field, auto_range = 'Off', manual_range = 1e-7)
#    electrometer.close()
## Here we apply tested functions to another instrument, a Keithley 2400 SourceMeter.
#    sourcemeter = Keithley6517A(rm, 'GPIB0::24::INSTR')
...
#    print(sourcemeter._error_query_())
#    sourcemeter.close()